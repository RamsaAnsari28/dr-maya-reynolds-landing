...
/>
      ...
      {/* MAIN CONTENT */}
      <main className="w-full bg-linear-to-br from-[#f7f3ef] via-[#eef5f2] to-[#f6f3ee] text-slate-800 font-sans">
...
<section className="max-w-7xl mx-auto px-6 py-28 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
  {/* Left Column: Text */}
  <div>
    <span className="inline-block mb-4 px-4 py-1 rounded bg-[#f6f3ee] text-[#8B5E3C] text-sm font-medium">
      Santa Monica, California
    </span>

    <h1 className="text-6xl font-bold leading-tight mb-6 text-slate-800">
    ...
    <button className="bg-[#8B5E3C] hover:bg-[#7A5234] transition-all duration-300 text-white px-8 py-4 rounded-full shadow-lg hover:shadow-xl hover:scale-105">
...
<section id="faq" className="bg-[#f6f3ee]">
  <div className="max-w-5xl mx-auto px-6 py-28">
    <h2 className=" text-4xl md:text-5xl font-bold mb-16 text-center text-slate-800">
    ...
    <div className="space-y-6">
      ...
      <footer className="bg-[#f6f3ee] mt-24">
        <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            <h4 className="text-2xl font-semibold text-slate-800 mb-4">Start Your Therapy Journey</h4>
            ...
            <button className="bg-[#8B5E3C]  hover:bg-[#7A5234] transition-all duration-300 text-white px-6 py-3 rounded-full shadow-md hover:shadow-lg hover:scale-105">
              Schedule a Consultation
            </button>
          </div>
        </div>
